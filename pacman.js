...
function showLifeLostPopup() {
    const notifier = document.getElementById("life-lost-notifier");
    const livesText = document.getElementById("lives-remaining");

    
    livesText.innerText = "Lives Remaining: " + lives;
